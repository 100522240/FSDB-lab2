...
create or replace package foundicu as 
    procedure insert_loan(l_signature char(5));
    procedure insert_reservation(isbn varchar2(20),res_date date);
    procedure record_books_ret(siganture char(5));
end;
/
...
create or replace package body foundicu as
    ...
    procedure insert_loan(l_signature char(5)) is 
        ...
        begin
            ...
            update loans
            set stopdate = sysdate and type = 'L'
            ...
            select count(*) int v_copy_available
            from copies
            ...
            --If the user is banned, raise an error
                ...
                raise_application_error(-20005, "The user is banned of using the library's services")
            end if;
            ...
            values (l_signature, v_user_id, sysdate, v_user_town, v_user_province, 'L');
            end if;
        exception
            when others then 
                raise_application_error(-20006, "Unexpected error happened");
        end insert_loan;
